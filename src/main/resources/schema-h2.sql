-- =====================================================================
--  ZLAGODA AIS - H2 schema (demo profile, auto-loaded at startup)
--  Mirrors schema-postgresql.sql. See that file for design notes.
-- =====================================================================
...
CREATE TABLE employee (
    ...
    CONSTRAINT chk_emp_phone CHECK (LENGTH(phone_number) <= 13)
);
...
CREATE TABLE customer_card (
    ...
    CONSTRAINT chk_cc_phone CHECK (LENGTH(phone_number) <= 13)
);
